      ...
      .catch()
            ...
            const navLinks=<>
             <li ><NavLink  className={({ isActive }) => (isActive ? 'text-xl text-orange-500 font-medium' : 'text-xl dark:text-green-600 font-medium')} to='/'>Home</NavLink></li>
               ...
               <li ><NavLink className={({ isActive }) => (isActive ? 'text-xl text-orange-500 font-medium' : 'text-xl dark:text-green-600 font-medium')} to='/artCraftItem' > All Art & craft Items</NavLink></li>
              <li><NavLink className={({ isActive }) => (isActive ? 'text-xl text-orange-500 font-medium' : 'text-xl dark:text-green-600  font-medium')} to='/addCraftItem'>Add Craft Item</NavLink></li>
              <li><NavLink  className={({ isActive }) => (isActive ? 'text-xl text-orange-500 font-medium' : 'text-xl dark:text-green-600 font-medium')} to='/artCraftList' >My Art&Craft List</NavLink></li>
